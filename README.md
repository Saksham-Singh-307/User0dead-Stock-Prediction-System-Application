...
## Objective
<p>
  The main objective of this project is to develop a web application that can predict stock price based on real-time data by which you can buy and sell stocks in your profile .  
</p>
